        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-black leading-relaxed">
              Committed to safeguarding your intellectual property with expert
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div>
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                FairfieldLaw is a distinguished law firm specializing in
                copyright and intellectual property law. With a focus on
                providing exceptional services such as DMCA takedowns,
                consultations, and legal protection, our team of experienced
                lawyers ensures the highest level of professionalism and
                efficiency.
              </p>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start mt-12">
            <div className="lg:order-2">
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                Our core values revolve around empowering and protecting
                creators. We are dedicated to helping individuals and businesses
                navigate the complexities of copyright and intellectual property
                law with clarity and confidence. At the heart of our practice is
                a client-first mindset — we believe in delivering thoughtful,
                tailored legal solutions that safeguard the ideas, brands, and
                innovations that matter most.
              </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive legal solutions tailored to protect your
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Swift and effective removal of infringing content across all
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Expert guidance on copyright registration, trademark protection,
                and IP strategy development.
              </p>
              <button className="text-amber-600 font-semibold flex items-center hover:text-amber-700">
                Learn More <ChevronRight className="ml-1 h-4 w-4" />
              </button>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Comprehensive legal representation for copyright infringement
                and IP disputes.
              </p>
              <button className="text-amber-600 font-semibold flex items-center hover:text-amber-700">
                Learn More <ChevronRight className="ml-1 h-4 w-4" />
      ...
      <section id="team" className="py-20 bg-slate-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our team of legal professionals is dedicated to safeguarding your
              rights and offering expert legal counsel
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  With a wealth of experience in intellectual property law,
                  Rebecca is committed to providing top-notch legal services to
                  our clients.
                </p>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Thomas' expertise in copyright law ensures our clients receive
                  tailored legal solutions that protect their creative assets
                  effectively.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center text-slate-700">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Elenas's focus on intellectual property intricacies allows her
                  to provide specialized advice that ensures clients'
                  intellectual creations are safeguarded.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center text-slate-700">
                    <Phone className="h-4 w-4 mr-2" />
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-slate-50 rounded-xl p-8 shadow-lg">
              ...
              <p className="text-gray-700 mb-6 italic leading-relaxed">
                "FairfieldLaw provided exceptional service in protecting my
                creative work. Their DMCA takedown process was swift and
            ...
            <div className="bg-slate-50 rounded-xl p-8 shadow-lg">
              ...
              <p className="text-gray-700 mb-6 italic leading-relaxed">
                "Professional, knowledgeable, and results-driven. The team
                helped us navigate complex IP issues with confidence and
      ...
      <footer className="bg-slate-800 text-gray-300 py-12">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Protecting your intellectual property with expert legal guidance
          ...
          <div className="border-t border-slate-700 mt-12 pt-8 text-center">
            <p>
              &copy; 2025 FairfieldLaw. All rights reserved. | Privacy Policy |
              Terms of Service
            </p>
          </div>
        </div>
